...
function AddDeliveryDriver(){
    ...
    async function sendData(e){
        ...
        else if (!did ||!fullname || !email || !password ||!repassword || !address || !phone || !age || !licenseno || !vehicleno || !nic || !basicsalary){
        ...
        await axios.post("http://localhost:8070/deliverydriver/adddd",{did,
        fullname,
        email,
        password,
        address,
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-5">
                                ...
                                <div className="card shadow-lg border-0 rounded-lg mt-5">
                                    <div className="card-header"><h3 className="text-center font-weight-light my-4">Add Delivery Driver</h3></div>
                                    <div className="card-body">
                                        <form method = "post">

                                        <div className="form-floating mb-3">
                                                <label>Delivery Driver Id :</label><br/><br/>
                                                <input className="form-control"  type="text" size={4} id = "did" name = "sid" placeholder="Type employee id" aria-required ="true" onChange={(e)=>{setDid(e.target
                                                    .value);}} />
                                            ...
                                            <div className="form-floating mb-3">
                                                ...
                                                <input className="form-control"  type="email" id = "em" name = "email" placeholder="Type email" onChange={(e)=> {setEmail(e.target.value);}} required/>
                                            </div>
                                            ...
                                            <div className="form-floating mb-3">
                                                ...
                                                <input className="form-control"  type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name = "password" placeholder="Type password" onChange={(e)=> {setRePassword(e.target.value);}} required/>
                                            </div>
                                            ...
                                            <div className="form-floating mb-3">
                                                ...
                                                <input className="form-control"  type="text" name = "licenseno" placeholder="Type license no" onChange={(e)=> {setLicenseNo(e.target.value);}} required/>
                                            </div>

                                            <div className="form-floating mb-3">
                                                <label>Vehicle No :</label><br/><br/>
                                                <input className="form-control"  type="text" name = "vehicleno" placeholder="Type vehicle no" onChange={(e)=> {setVehicleNo(e.target.value);}} required/>
                                            </div>

                                            <div className="form-floating mb-3">
                                                <label>NIC No :</label><br/><br/>
                                                <input className="form-control"  type="text" name = "nic" placeholder="Type nic no" onChange={(e)=> {setNic(e.target.value);}} required/>
                                            </div>
