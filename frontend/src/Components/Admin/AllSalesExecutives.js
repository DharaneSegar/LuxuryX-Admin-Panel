        ...
        <div className="mt-5">
                <div className="container">
                    ...
                    <input className="form-control" type="text" placeholder="Type Sid here" aria-label="Search for..." aria-describedby="btnNavbarSearch" onChange={(e) =>{
                        ...
                        <a className="btn btn-primary" href='http://localhost:3000/reportse' id = "pdf" onClick={modal}>Generate Report</a>
                        ...
                        <tbody>
                            {
                                salesexecutives.filter((s) => 
                                    ...
                                    <td className='d-flex justify-content-between'>
                                        ...
                                        <button className='btn' onClick={(e)=> GET(salesexecutive.sid)} data-toggle="modal" data-target="#myModal"><RemoveRedEyeIcon/></button>
                                        <button className='btn btn-danger' onClick={() =>{
                                             axios.delete(`http://localhost:8070/salesexecutive/deletese/${salesexecutive._id}`)
                                             axios.delete(`http://localhost:8070/t/delete/${salesexecutive.sid}`)
                                            .then((res) => {
                                                if(res.data === "success"){
