...
function ViewSalaryDD(){
    ...
    useEffect(()=>{
        function get(){
            axios.get(`http://localhost:8070/salary/getEid/${user.did}`).then((res) => {
...
<div className="mt-5">
                ...
                <div className="input-group">
                    <input className="form-control" type="text" placeholder="Type Date here" aria-label="Search for..." aria-describedby="btnNavbarSearch" onChange={(e) =>{
                    ...
                    <table className="table">
                        ...
                        {
                                salaries.filter((e) => 
                                e.paydate.toLowerCase().includes(query)).map((e) => (
